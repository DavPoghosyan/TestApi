...
public class AgencyService {
    ...
    /**
     * Add a new agency. If an agency with the same 'name' or 'code' exists, return an error message.
     */
    ...
    /**
     * Update an existing agency. If updates are not allowed or the agency is not found, return an error message.
     */
    public String updateAgency(Agency updatedAgency) {
        ...
        Optional<Agency> existingAgency = agencies.stream()
            .filter(agency -> agency.getId().equals(updatedAgency.getId()))
            .findFirst();
